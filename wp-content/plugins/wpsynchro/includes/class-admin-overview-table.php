...
class AdminOverviewTable extends \WP_List_Table
{
    ...
    function column_name($item)
    {
        ...
        return "<a href='" . $editlink . "'>" . htmlspecialchars($item->name) . '</a>';
    }
    ...
    function column_actions($item)
    {
        ...
        if ($item->canRun()) {
            $runlink = add_query_arg(array('syncid' => $item->id, 'jobid' => uniqid()), menu_page_url('wpsynchro_run', false));
        ...
        $delete = add_query_arg('delete', $item->id, menu_page_url('wpsynchro_overview', false));
        $actions .= "<a class='button deletejob' href='" . $delete . "' onclick='return confirm(\"" . __('Are you sure you want to delete this?', 'wpsynchro') . "\"); '>" . __('Delete job', 'wpsynchro') . '</a>';
